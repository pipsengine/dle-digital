            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredTimesheets.map((item) => {
                  ...
                  const reviewHref = `/hris/time-and-logs/timesheet-review?headerId=${encodeURIComponent(item.id)}`;
                    ...
                    <tr key={item.id} className="hover:bg-slate-50/70">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center justify-end gap-2">
                          <Link href={reviewHref} className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-3 py-2 text-[10px] font-black uppercase tracking-widest text-white hover:bg-slate-800">
