...
const titleOverrides: Record<string, string> = {
  ...
  '/hris/payroll/sage-reconciliation': 'Sage vs Enterprise Payroll Reconciliation',
  ...
  '/hris/workforce-management/overtime-management': 'Overtime Management',
  '/hris/benefits-management': 'Benefits Management',
  '/hris/benefits/overview': 'Benefits Overview',
  '/hris/benefits/benefit-plans': 'Benefit Plans',
  '/hris/benefits/medical-benefits': 'Medical Benefits',
  '/hris/benefits/insurance-benefits': 'Insurance Benefits',
  '/hris/benefits/pension-benefits': 'Pension Benefits',
  '/hris/benefits/staff-welfare': 'Staff Welfare',
  '/hris/benefits/allowance-benefits': 'Allowance Benefits',
  '/hris/benefits/benefit-eligibility': 'Benefit Eligibility',
  '/hris/benefits/benefit-enrollment': 'Benefit Enrollment',
  '/hris/benefits/benefit-claims': 'Benefit Claims',
  '/hris/benefits/benefit-approval': 'Benefit Approval',
  '/hris/benefits/providers-and-vendors': 'Providers & Vendors',
  '/hris/benefits/compliance': 'Compliance',
  '/hris/benefits/benefit-reports': 'Benefit Reports',
  '/hris/benefits/benefits-settings': 'Benefits Settings',
